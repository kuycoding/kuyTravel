...
import com.kuycoding.kuytravel.ui.admin.travel.CommentTravelActivity;
...
public class TravelDetailActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout_booking = findViewById(R.id.linearLayout2);
        ...
        fStore.collection("usersTravel").document(travel.getUid()).get()
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        Intent intent = new Intent(TravelDetailActivity.this, TravelBookingActivity.class);
                        intent.putExtra(TravelBookingActivity.EXTRACT_BOOKING, travel);
                        intent.putExtra(TravelBookingActivity.EXTRACT_USERS, users);
                        startActivity(intent);
                    }
                }).addOnFailureListener(e -> Log.d(TAG, "onFailure: gagal intent"));
    }
    ...
    private void addFav() {
        ...
        dbfav.set(fav).addOnSuccessListener(aVoid -> Log.d(TAG, "onSuccess: add favorite"));
    }
